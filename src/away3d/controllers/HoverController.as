package away3d.controllers
{
	...
	public class HoverController extends LookAtController
	{
		...
		private var _minTiltAngle:Number = -Infinity;// -90;
		private var _maxTiltAngle:Number = Infinity;//90;
		...
		public override function update(interpolate:Boolean = true):void
		{
			...
			//_targetObject.y = _pos.y + _distance * Math.sin(_currentTiltAngle * MathConsts.DEGREES_TO_RADIANS);//* Math.cos(_currentTiltAngle * MathConsts.DEGREES_TO_RADIANS);
			//_targetObject.z = _pos.z + _distance * Math.cos(_currentTiltAngle * MathConsts.DEGREES_TO_RADIANS);// * Math.cos(_currentTiltAngle * MathConsts.DEGREES_TO_RADIANS);
